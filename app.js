// Facturación local + jsPDF + Enlaces de pago + Contact Picker (sin backend)
window.addEventListener('DOMContentLoaded', () => {
  ...
  async function pickContactsAndSave({selectFor='clients'}){
    if (!(await supportsContactPicker())) {
      alert('El Contact Picker no está disponible en este navegador. Usa Chrome en Android o HTTPS con el flag activo en iOS.');
      return;
    }
